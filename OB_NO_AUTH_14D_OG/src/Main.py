...
import Functions.Data_encoding as DE
from Functions.Bivariates import bivar_exec

query = "SELECT * FROM  Financebi_db.panc.OB_NOIC_ADS_ASOF0923F1 "
Ob_Noic_23 = pd.read_sql_query(query, con=snowflake_conn())

file_path = 'Data/Input/Ob_Noic_23.pkl'
...
imputation_methods = {'deductible': 'Median', 'coinsurance': 'Median', 'moop': 'Median',
                      ...
                      'days_since_last_call':'outlier', 'days_since_last_callog':'outlier','days_since_last_email':'outlier'}
...
DE.data_encoding_fit(src=r'C:\Users\ParnikaPancholi\PycharmProjects\Ob_no_Auth\Data\Input',
...
DE.data_encoding_transform(src=r'C:\Users\ParnikaPancholi\PycharmProjects\Ob_no_Auth\Data\Input',
           oup=r'C:\Users\ParnikaPancholi\PycharmProjects\Ob_no_Auth\Data\Output',
           wrk=r'C:\Users\ParnikaPancholi\PycharmProjects\Ob_no_Auth\Data\Work',
